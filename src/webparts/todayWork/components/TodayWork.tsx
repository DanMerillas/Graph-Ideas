...
export default class TodayWork extends React.Component<ITodayWorkProps, {}> {
  ...
  public async componentDidMount(): Promise<void> {
    ...
    const view4 = await graph.me.calendarView("2023-04-20", "2023-04-30")();
  ...
  public render(): React.ReactElement<ITodayWorkProps> {
    ...
    return (
      <section className={`${styles.todayWork} ${hasTeamsContext ? styles.teams : ''}`}>
